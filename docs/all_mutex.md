...
Utility script for all mutex.

## Location

`mutex-spi/all_mutex.py`

## Usage

```bash
python mutex-spi/all_mutex.py
```
...
- This file could not be fully parsed: `Missing parentheses in call to 'print'. Did you mean print(...)? at line 56`
