...
Utility script for smx prof.

## Location

`mutex-spi/smx_prof.py`

## Usage

```bash
python mutex-spi/smx_prof.py
```
...
- This file could not be fully parsed: `Missing parentheses in call to 'print'. Did you mean print(...)? at line 95`
